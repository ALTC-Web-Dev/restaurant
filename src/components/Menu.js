...
export default function Menu() {
  return (
    <section className="lg:px-32 md:px-20 px-4 bg-hero bg-cover bg-no-repeat min-h-full flex flex-col justify-center items-center">
      <div className="flex flex-col justify-center items-center lg:flex-row lg:justify-between lg:w-9/12 w-full py-10 mb-20">
        <img
          src="/asset/noodles.png"
          alt="Boat noodles"
          className="lg:mr-10 lg:mb-20"
        />
        <div className="flex flex-col lg:w-[500px] gap-y-6">
